                ...
                <div class="row">
                    <div class="col-md-12 report-table" style="height: 72vh;">
                        ...
                        <table class="table table-hover table-remove-borders" style="background-color: #2A2E32; color: white;">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM recovery_requests";
                                ...
                                if ($result_recovery->num_rows > 0) {
                                    while ($row = $result_recovery->fetch_assoc()) {
                                        ...
                                        // Unban Modal
                                        echo "<div class='modal fade' id='unbanModal_" . $row['email'] . "' tabindex='-1' aria-labelledby='unbanModalLabel' aria-hidden='true'>
                                                <div class='modal-dialog modal-dialog-centered'>
                                                    <div class='modal-content'>
                                                        ...
                                                        <div class='modal-body'>
                                                            Are you sure you want to unban the account associated with " . htmlspecialchars($row['email']) . "?
                                                        </div>
                                                        <div class='modal-footer'>
                                                            <button type='button' class='btn btn-secondary' data-bs-dismiss='modal'>Cancel</button>
                                                            <a href='../../function/php/unban_user.php?email=" . urlencode($row['email']) . "' class='btn btn-success'>Yes, Unban</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>";
                                        ...
                                        echo "<div class='modal fade' id='declineModal_" . $row['email'] . "' tabindex='-1' aria-labelledby='declineModalLabel' aria-hidden='true'>
                                                <div class='modal-dialog modal-dialog-centered'>
                                                    <div class='modal-content'>
                                                        ...
                                                        <div class='modal-footer'>
                                                            <button type='button' class='btn btn-secondary' data-bs-dismiss='modal'>Cancel</button>
                                                            <a href='../../function/php/decline_recovery.php?email=" . urlencode($row['email']) . "' class='btn btn-danger'>Yes, Decline</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>";
