<?php
    ...
    $stmt = $conn->prepare("SELECT profile_image, template FROM template1 WHERE email = ?");
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <?php if ($row['template'] === 'grid'): ?>
                            <div class="col-md-3 mb-3">
                                <img src="../../../../assets/img/profile/<?= $row['profile_image'] ?>" class="img-fluid img-wh" alt="User Image">
                            </div>
                        <?php endif; ?>
                    <?php endwhile; ?>
                </div>
